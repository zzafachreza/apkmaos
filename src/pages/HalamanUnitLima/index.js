...
function HalamanUnitLima({ navigation }) {
        ...
        <View style={{ flex: 1, backgroundColor: colors.white, }}>
            ...
            <View style={{ backgroundColor: colors.secondary, padding: 10, borderBottomLeftRadius: 20, borderBottomRightRadius: 20, bottom: 30 }}>
                ...
                <View style={{ padding: 10, }}>
                    <Text style={{ fontSize: 25, fontFamily: 'Alata-Regular', color: colors.white, textAlign: 'center' }} >Unit 5</Text>
                </View>
            </View>
            <ScrollView>

                <View style={{ padding: 10, top: 5, alignItems: 'center' }}>
                    <Image style={{ width: 270, height: 200, resizeMode: 'contain' }} source={require('../../assets/img/potounitlima.png')} />
                </View>

                <View style={{ padding: 10, top: 10 }} >
                    <Text style={{ fontFamily: 'Alata-Regular', fontSize: 30, textAlign: 'center' }} >Unit 5 :</Text>
                </View>

                <View style={{ padding: 10, top: 25 }} >
                    <Text style={{ fontFamily: 'Alata-Regular', fontSize: 25, bottom: 40, textAlign: 'center' }} >Buy 1, Get 1 Free</Text>
                </View>
                ...
                <View style={{ padding: 10, flex: 1 }} >
                    ...
                    <View style={{
                        ...
                        <Text style={{ fontFamily: 'Alata-Regular', fontSize: 15, left: 5, maxWidth: '95%' }} >
                            Identify the promotion of products and services through simple and basic advertisements.
                        </Text>
                    </View>
                    <View style={{
                        flexDirection: 'row',
                        ...
                        <Text style={{ fontFamily: 'Alata-Regular', fontSize: 15, left: 5, }} >
                            Compare the types of advertisements.
                        </Text>
                    </View>

                </View>
                <View style={{ padding: 10, margin: 0, bottom: 12 }} >
...
export default HalamanUnitLima;