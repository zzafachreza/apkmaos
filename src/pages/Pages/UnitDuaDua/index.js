...
function KelompokTaksDuaDua({ navigation }) {
        ...
        <View style={{ flex: 1, backgroundColor: colors.white, }}>
            ...
            <ScrollView>
                ...
                <View style={{ padding: 10, alignItems: 'center', }}>
                    <Image style={{ width: 316, height: 1459, }} source={require('../../../assets/img/unitdua/unitdua(2).png')} />
                </View>
...
export default KelompokTaksDuaDua;