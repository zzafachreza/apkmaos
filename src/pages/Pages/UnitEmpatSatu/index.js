...
function KelompokTaksEmpatSatu({ navigation }) {
        ...
        <View style={{ flex: 1, backgroundColor: colors.white, }}>
            ...
            <View style={{ backgroundColor: colors.secondary, padding: 10, borderBottomLeftRadius: 20, borderBottomRightRadius: 20, bottom: 30 }}>
                <View style={{ flexDirection: 'row', padding: 10, top: 25 }} >
                    <TouchableOpacity onPress={() => navigation.navigate('HalamanUnitEmpat')} >
            ...
            <ScrollView>
                ...
                <View style={{ padding: 10 }}>
                    <Text style={{ fontFamily: 'Alata-Regular', fontSize: 20, textAlign: 'center', color: colors.secondary }}>What information do you get?</Text>
                </View>

                <View style={{ padding: 10, alignItems: 'center' }}>
                    <Image style={{ width: 309, height: 290, }} source={require('../../../assets/img/unitempat/unitempat(letstart).png')} />
                </View>

                <View style={{ padding: 10, alignItems: 'center' }}>
                    <Image style={{ width: 321, height: 164, }} source={require('../../../assets/img/unitempat/unitempat(letstart2).png')} />
                </View>


                <View style={{ padding: 10, margin: 20, }} >
                    <TouchableOpacity onPress={() => navigation.navigate('KelompokTaksEmpatDua')} style={{ padding: 10, backgroundColor: colors.primary, borderRadius: 10, }} >
...
export default KelompokTaksEmpatSatu;