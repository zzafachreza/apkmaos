...
function KelompokTaksDuaLima({ navigation }) {
        ...
        <View style={{ flex: 1, backgroundColor: colors.white, }}>
            ...
            <View style={{ backgroundColor: colors.secondary, padding: 10, borderBottomLeftRadius: 20, borderBottomRightRadius: 20, bottom: 30 }}>
                <View style={{ flexDirection: 'row', padding: 10, top: 25 }} >
                    <TouchableOpacity onPress={() => navigation.navigate('KelompokTaksDuaEmpat')} >
            ...
            <ScrollView>
                ...
                <View style={{ padding: 10, alignItems: 'center', }}>
                    <Image style={{ width: 349, height: 574, }} source={require('../../../assets/img/unitdua/unitdua(5).png')} />
                </View>
                ...
                <View>
                    ...
                    <View style={{ padding: 10, }}>
                        <Text style={{ fontFamily: 'Alata-Regular', fontSize: 15 }}>2. What kind of vegetables do we need to cook tamarind
                            soup?</Text>
                    </View>
                    ...
                    <View style={{ padding: 10, }}>
                        <Text style={{ fontFamily: 'Alata-Regular', fontSize: 15 }}>3. What should we do before we serve the rice and other
                            dishes?</Text>
                    </View>
                    ...
                    <View style={{ padding: 10, }}>
                        <Text style={{ fontFamily: 'Alata-Regular', fontSize: 15 }}>4. How much brown sugar do we need to cook tamarind
                            soup?</Text>
                    </View>
                    ...
                    <View style={{ padding: 10, }}>
                        <Text style={{ fontFamily: 'Alata-Regular', fontSize: 15 }}>5. What is the main ingredient of tamarind soup?</Text>
                    </View>
                ...
                <View style={{ padding: 10, margin: 20, }} >
                    <TouchableOpacity onPress={() => navigation.navigate('KelompokTaksDuaEnam')} style={{ padding: 10, backgroundColor: colors.primary, borderRadius: 10, }} >
...
export default KelompokTaksDuaLima;