        ...
        <View style={{ flex: 1, backgroundColor: colors.white, }}>
            ...
            <ScrollView>
                ...
                <View style={{ padding: 10, margin: 20, }} >
                    <TouchableOpacity onPress={() => navigation.navigate('KelompokTaksDuaDua')} style={{ padding: 10, backgroundColor: colors.primary, borderRadius: 10, }} >
...
export default KelompokTaksDua;