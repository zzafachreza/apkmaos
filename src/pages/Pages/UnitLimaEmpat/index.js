...
function KelompokTaksLimaEmpat({ navigation }) {
        ...
        <View style={{ flex: 1, backgroundColor: colors.white, }}>
            ...
            <View style={{ backgroundColor: colors.secondary, padding: 10, borderBottomLeftRadius: 20, borderBottomRightRadius: 20, bottom: 30 }}>
                <View style={{ flexDirection: 'row', padding: 10, top: 25 }} >
                    <TouchableOpacity onPress={() => navigation.navigate('KelompokTaksLimaTiga')} >
            ...
            <ScrollView>
                ...
                <View style={{ padding: 10, top: 30, alignItems: 'center', }}   >
                    <Image style={{ width: 326, height: 501, }} source={require('../../../assets/img/unitlima/unitlima(1).png')} />
                </View>
                ...
                <View>
                    ...
                    <View style={{ padding: 10, }}>
                        <Text style={{ fontFamily: 'Alata-Regular', fontSize: 15 }}>2. What is being advertised in the text?</Text>
                    </View>
                    ...
                    <View style={{ padding: 10, }}>
                        <Text style={{ fontFamily: 'Alata-Regular', fontSize: 15 }}>3. “Low down payment and installment; special price and gift for full payment.” What can we infer from the sentences?</Text>
                    </View>
                    ...
                    <View style={{ padding: 10, }}>
                        <Text style={{ fontFamily: 'Alata-Regular', fontSize: 15 }}>4. Why are the people probably interested in the advertised item?</Text>
                    </View>
                    ...
                    <View style={{ padding: 10, }}>
                        <Text style={{ fontFamily: 'Alata-Regular', fontSize: 15 }}>5. What should people do to know more about the information?</Text>
                    </View>
                ...
                <View style={{ padding: 10, margin: 20, }} >
                    <TouchableOpacity onPress={() => navigation.navigate('KelompokTaksLimaLima')} style={{ padding: 10, backgroundColor: colors.primary, borderRadius: 10, }} >
...
export default KelompokTaksLimaEmpat;