...
function HalamanTaks3({navigation}) {
...
<View   style={{flexDirection:'row', padding:10,top:25 }} >
  ...
  <Text style={{ fontSize:25, fontFamily:'Alata-Regular', color:colors.white, textAlign:'center'}} >Taks 3</Text>
  </View>
</View>
<ScrollView>
