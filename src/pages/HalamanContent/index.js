...
function HalamanContent({navigation}) {
...
<View   style={{flexDirection:'row', padding:10, top:25 }} >
    <TouchableOpacity   onPress={()=>navigation.navigate('HalamanReception')} >
        <Image   style={{width:24, height:24}}  source={require('../../assets/img/back.png')} />
    </TouchableOpacity>
</View>

  <View style={{padding:10, bottom:10 }}>
  <Text style={{ fontSize:20, fontFamily:'Alata-Regular', color:colors.white, textAlign:'center'}} >New Knowledge
Content</Text>
  </View>
...
<View style={{padding:10,  top:5 , margin:20}} >
    <TouchableOpacity onPress={()=>navigation.navigate('HalamanStrategy')}  style={{padding:10, backgroundColor:colors.primary, borderRadius:10,}} >
