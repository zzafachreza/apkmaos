...
function HalamanStudent0({ navigation }) {
        ...
        <View style={{ flex: 1, backgroundColor: colors.white, }}>
            ...
            <View style={{ backgroundColor: colors.secondary, padding: 10, borderBottomLeftRadius: 20, borderBottomRightRadius: 20, bottom: 30 }}>
                ...
                <View style={{ padding: 10, }}>
                    <Text style={{ fontSize: 25, fontFamily: 'Alata-Regular', color: colors.white, textAlign: 'center' }} >Student’s Guidance</Text>
                </View>
            </View>
            ...
            <View style={{
                ...
                <View style={{ padding: 10, bottom: 5, alignItems: 'center' }}>
                    <Image style={{ width: 250, height: 250, resizeMode: 'contain' }} source={require('../../assets/img/potostudent.png')} />
                </View>

                <View style={{ padding: 10, top: 50, paddingBottom: 250, margin: 20 }} >
                    <TouchableOpacity onPress={() => navigation.navigate('HalamanStudent')} style={{ padding: 10, backgroundColor: colors.primary, paddingHorizontal: 80, borderRadius: 10, }} >
...
export default HalamanStudent0;