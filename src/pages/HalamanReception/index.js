...
function HalamanReception({navigation}) {
...
<View   style={{flexDirection:'row', padding:10, top:25  }} >
  ...
  <Text style={{ fontSize:25, fontFamily:'Alata-Regular', color:colors.white, textAlign:'center'}} >Reception</Text>
  </View>
</View>
<ScrollView>
...
<View style={{padding:10, top:5, margin:20 }} >
    <TouchableOpacity  onPress={()=>navigation.navigate('HalamanContent')} style={{padding:10, backgroundColor:colors.primary,  borderRadius:10,}} >
...
export default HalamanReception;