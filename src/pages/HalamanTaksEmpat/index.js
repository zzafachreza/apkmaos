...
function HalamanTaks4({navigation}) {
...
<View   style={{flexDirection:'row', padding:10,  top:25 }} >
    <TouchableOpacity   onPress={()=>navigation.navigate('HalamanResultTaks3')} >
        <Image   style={{width:24, height:24}}  source={require('../../assets/img/back.png')} />
    </TouchableOpacity>
</View>

  <View style={{padding:10, bottom:10}}>
  <Text style={{ fontSize:25, fontFamily:'Alata-Regular', color:colors.white, textAlign:'center'}} >Taks 4</Text>
  </View>
</View>
<ScrollView>
...
<View style={{padding:10,  top:5, margin:20}} >
    <TouchableOpacity  onPress={()=>navigation.navigate('HalamanResultTaks4')} style={{padding:10, backgroundColor:colors.primary, borderRadius:10,}} >
